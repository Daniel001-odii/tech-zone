    ...
    <div class="pt-20 h-full max-w-screen-2xl mx-auto my-0">
        <div class="flex flex-row justify-center items-center bg-[#EDEFF3] min-h-[300px]" >
            <div class="p-5 w-full text-center justify-center flex flex-col items-center">
                ...
                <p class=" max-w-[500px] text-[12px] text-center">ApexTek is a platform where talent meets opportunities, propelling Nigeria’s Tech industry to new heights of excellence and prosperity. It bridges the gap between companies and Tech Professionals.</p>
            </div>
        </div>
...
ApexTek bridges the gap between companies and Tech Professionals, facilitating meaningful connections that drive growth, innovation and success. ApexTek is a platform where talent meets opportunities, propelling Nigeria’s Tech industry to new heights of excellence and prosperity.  </p>
