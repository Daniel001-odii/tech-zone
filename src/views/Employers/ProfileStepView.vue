                                    ...
                                    <div v-if="step === 0">
                                        ...
                                        <div class="form-section">
                                            <div class="form-control">
                                                ...
                                                <input class="form_input" type="text" name="company_name" id="company_name" minlength="3" maxlength="50" v-model="user_form.profile.company_name" placeholder="Company Name">
                                            </div>
                                            <div class="form-control">
                                                <label for="tag_line">Company Tagline</label>
                                                <textarea class="form_input" type="text" name="tag_line" id="tag_line" v-model="user_form.profile.tag_line" placeholder="Company's Tagline/Statement"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-section">
                                            <div class="form-control">
                                                ...
                                                <input class="form_input" type="textarea" name="description" id="description" minlength="20" v-model="user_form.profile.description" placeholder="A brief description about your company">
                                            </div>
                                        </div>
                                        
                                        <button type="button" @click="step += 1":disabled="!user_form.profile.company_name || !user_form.profile.tag_line || !user_form.profile.description" class="btn w-full">Next</button>
                                    </div>
                                    ...
                                    <div v-if="step === 2">
                                        ...
                                        <div class="form-section">
                                            <div class="form-control">
                                                ...
                                                <input class="form_input" type="phone" name="phone" id="phone"  min="11" maxlength="11"  v-model="user_form.profile.phone" placeholder="+234123456789">
                                            </div>
